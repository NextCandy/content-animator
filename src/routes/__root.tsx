  ...
  head: () => ({
    meta: [
      ...
      { title: "The Content Architecture" },
      {
        name: "description",
        content:
          "The Next.js and Sanity architecture agents don't reinvent. Six years of decisions, committed.",
      },
      { name: "author", content: "Edoardo Lunardi" },
      { property: "og:title", content: "The Content Architecture" },
      {
